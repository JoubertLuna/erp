...
use App\Http\Requests\ERP\Painel\ResourceRequest;
...
class ResourceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('erp.painel.pages.resource.index', compact('resources'));
    }
    ...
    {
        return view('erp.painel.pages.resource.create');
    }
    ...
    public function show($url)
    {
        ...
        return view('erp.painel.pages.resource.show', compact('resource'));
    }
    ...
    public function edit($url)
    {
        ...
        return view('erp.painel.pages.resource.edit', compact('resource'));
    }
