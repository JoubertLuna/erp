...
class ResourceRoleController extends Controller
{
    ...
    public function resources($idRole)
    {
        ...
        return view('erp.painel.pages.role.resources.resources', compact('resources', 'role'));
    }
    ...
    public function roles($idResource)
    {
        ...
        return view('erp.painel.pages.resource.role.role', compact('resource', 'roles'));
    }
    ...
    public function resourcesAvailable($idRole)
    {
        ...
        return view('erp.painel.pages.role.resources.available', compact('resources', 'role'));
    }
